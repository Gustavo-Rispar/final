<?php
    ...
    if (isset($_POST['delete'])) {
        ...
        // Insere os dados no banco
        $result =mysqli_query($conexao, "DELETE FROM `funcionario` WHERE `funcionario`.`cod_Funcionario` = $cod;");
    ...
    if (isset($_POST['alterar'])) {
        ...
        $result = mysqli_query($conexao, "UPDATE `funcionario` SET `nome_func`='$nome', `telefone`='$telefone', `senha`='$senha', `cargo`='$cargo', `salario`='$salario' WHERE `cod_Funcionario` = '$cod'");
    }
